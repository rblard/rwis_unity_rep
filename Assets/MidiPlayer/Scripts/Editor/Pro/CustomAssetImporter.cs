...
namespace MidiPlayerTK
{
    internal sealed class CustomAssetImporter : AssetPostprocessor
    {
        ...
        private void OnPreprocessAudio()
        {
            ...
            //Debug.Log($"defaultSampleSettings {MidiPlayerGlobal.ImSFCurrent.SoundFontName}  {MidiPlayerGlobal.ImSFCurrent.CompressionFormat} {MidiPlayerGlobal.ImSFCurrent.LoadType}");
